...
HD_PWD='C:/Users/srina/Desktop/AES/Srinath_AES_PYNQ/AES_MIX_IMIX/MIX_IMIX/MIX_IMIX.runs/design_1_myip_mix_imix_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myip_mix_imix_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myip_mix_imix_0_0.tcl
